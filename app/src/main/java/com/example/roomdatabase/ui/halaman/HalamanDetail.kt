...
import com.example.roomdatabase.model.ItemDetailsUiState
import com.example.roomdatabase.model.PenyediaViewModel
import com.example.roomdatabase.model.toSiswa
...
fun DetailsScreen(
    ...
    Scaffold (
        topBar = {
            ...
            FloatingActionButton(onClick = {navigateToEditItem(uiState.value.detailSiswa.id)},
...
private fun ItemDetailsBody(
    ...
    Column (
        ...
        ItemDetails(
            siswa = itemDetailsUiState.detailSiswa.toSiswa(),modifier = Modifier.fillMaxWidth()
        )
